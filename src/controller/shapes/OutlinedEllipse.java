...
public class OutlinedEllipse extends Shape implements IShape {
    ...
    public OutlinedEllipse(controller.Point start, Point end, int width, int height, ShapeType shapeType, ShapeColor primaryColor, ShapeColor secondaryColor, ShapeShadingType shadingType, PaintCanvasBase canvas){
