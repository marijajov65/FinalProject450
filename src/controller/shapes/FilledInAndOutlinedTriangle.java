...
public class FilledInAndOutlinedTriangle extends Shape implements IShape {
    public FilledInAndOutlinedTriangle(controller.Point start, Point end, int width, int height, ShapeType shapeType, ShapeColor primaryColor, ShapeColor secondaryColor, ShapeShadingType shadingType, PaintCanvasBase canvas) {
